...
> Simple find and remove duplicate files

[![PyPI version](https://badge.fury.io/py/simple-duplicate-finder.svg)](https://pypi.org/project/simple-duplicate-finder/)
...
```bash
pip install simple-duplicate-finder
```
...
result = finder("Hello World")

# Example 2: Batch processing
from simple_duplicate_finder import batch
